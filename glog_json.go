...
func newStruct(depth int, s severity, level Level) *Struct {
	if logging.verbosity.get() >= level {
		return logging.structHeader(depth, s, level)
	}
...
func (log *loggingT) structHeader(depth int, sev severity, level Level) *Struct {
